  ...
  <v-container class="py-4">
    ...
    <v-card class="rounded-xl border-0 elevation-2 pa-5 mb-4 border-start-primary">
      ...
      <p class="text-body-2 text-high-emphasis mb-3 line-height-relaxed">
        <strong>Obrafácil Comarapa</strong> es un proyecto creado con mucho cariño para apoyar a los maestros de obra, albañiles, constructores y familias de nuestra querida comunidad de <strong>Comarapa</strong> (Santa Cruz, Bolivia). Nuestro objetivo es brindar una herramienta fácil, entendible y práctica para calcular materiales y estimar costos de construcción de forma rápida.
      </p>
      ...
      <v-row density="compact" class="mt-1">
        <v-col cols="12" sm="6">
          <v-card class="pa-3 rounded-lg border-0 bg-surface-variant d-flex align-center">
            <v-avatar color="primary" size="40" class="mr-3 font-weight-bold text-white">
              FT
            </v-avatar>
            <div>
              <div class="font-weight-bold text-subtitle-2">Fiorella Tapia Berbettu</div>
        ...
        <v-col cols="12" sm="6">
          <v-card class="pa-3 rounded-lg border-0 bg-surface-variant d-flex align-center">
            <v-avatar color="accent" size="40" class="mr-3 font-weight-bold text-white">
              AT
            </v-avatar>
            <div>
              <div class="font-weight-bold text-subtitle-2">Alex Tapia</div>
              <div class="text-caption text-medium-emphasis">Estudiante de 6to de Secundaria</div>
            </div>
          </v-card>
        </v-col>
    ...
    <v-row density="comfortable">
      ...
      <v-col cols="12" sm="6">
        <v-card class="pa-4 rounded-xl border-0 elevation-2 h-100">
          ...
          <p class="text-body-2 text-medium-emphasis mb-0">
            Calcula en un solo paso la cantidad total de ladrillos, bolsas de cemento, arena, ripio, cerámica de piso y agua para construir una habitación completa.
          </p>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6">
        <v-card class="pa-4 rounded-xl border-0 elevation-2 h-100">
          ...
          <p class="text-body-2 text-medium-emphasis mb-0">
            Dosificación exacta para Ladrillo de 6 Huecos, Ladrillo Adobito, Ladrillo Visto (18H), Bloques de Hormigón y Ladrillos para Losa.
          </p>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6">
        <v-card class="pa-4 rounded-xl border-0 elevation-2 h-100">
          ...
          <p class="text-body-2 text-medium-emphasis mb-0">
            Calcula cimientos, zapatas, columnas, vigas y contrapisos con medidas simples (Largo × Ancho × Grosor) y mezclas 1:2:3 y 1:2:4 en latas y carretillas.
          </p>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="6">
        <v-card class="pa-4 rounded-xl border-0 elevation-2 h-100">
          ...
          <p class="text-body-2 text-medium-emphasis mb-0">
            Obtén el desglose financiero estimado de tu obra en Bolivianos (Bs.) con precios unitarios de mercado editables y opción de exportar el resumen.
          </p>
        </v-card>
      </v-col>
    </v-row>
