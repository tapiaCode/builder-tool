      ...
      <v-card-text class="pa-5">
        <div class="d-flex align-center justify-space-between">
          <div>
            ...
            <p class="text-body-2 text-medium-emphasis mb-0">Ladrillos locales con foto, bolsas de cemento, ripio y piezas en medidas simples</p>
          </div>
          ...
          <v-row density="compact">
            <v-col v-for="brick in brickOptions" :key="brick.value" cols="6" sm="4" md="2.4">
              <v-card
                ...
                @click="roomData.brickType = brick.value; calcRoom()"
              >
          ...
          <v-alert type="info" variant="tonal" border="start" class="my-3 py-2">
            <div class="d-flex align-center justify-space-between flex-wrap gap-2">
              <span class="text-body-2">
                <strong>Cuarto:</strong> {{ roomData.lengthM }}m × {{ roomData.widthM }}m ({{ results.room?.floorArea }} m² de piso) | <strong>Paredes netas:</strong> {{ results.room?.netWallArea }} m²
              </span>
            </div>
          </v-alert>
        </v-card>
            ...
            <v-row density="compact">
              ...
              <v-col cols="6" sm="3">
                <v-card class="pa-3 rounded-xl border-0 stat-card-gradient-primary text-center">
                  ...
                  <v-chip size="x-small" color="warning" variant="tonal" class="mt-1">~{{ results.room.sandWheelbarrows }} Carretillas</v-chip>
                </v-card>
              </v-col>
              ...
              <v-col cols="6" sm="3">
                <v-card class="pa-3 rounded-xl border-0 stat-card-gradient-success text-center">
                  ...
                  <v-chip size="x-small" color="info" variant="tonal" class="mt-1">~{{ results.room.ripioWheelbarrows }} Carretillas</v-chip>
                </v-card>
              </v-col>
            </v-row>
        ...
        <v-card class="rounded-xl border-0 elevation-2 pa-4 mb-4">
          ...
          <v-alert type="info" variant="tonal" border="start" class="my-3 py-2">
            <div class="d-flex align-center justify-space-between flex-wrap">
              <span class="text-body-2">
                <strong>Espacio calculado:</strong> {{ concreteDimensions.length }}m × {{ concreteDimensions.width }}m × {{ concreteDimensions.thickness }}cm
              </span>
          ...
          <v-row density="compact">
            ...
            <v-col cols="12" sm="6">
              ...
              >
                ...
                <div class="text-caption font-weight-bold text-accent mb-1">
                  1 Cemento : 2 Arena : 4 Ripio
                </div>
                <div class="text-caption text-medium-emphasis">
            ...
            <v-row density="compact">
              ...
              <v-col cols="6" sm="3">
                <v-card class="pa-3 rounded-xl border-0 stat-card-gradient-primary text-center">
                  ...
                  <div class="text-caption text-medium-emphasis">Ripio / Chispa</div>
                  <v-chip size="x-small" color="warning" variant="tonal" class="mt-1">~{{ results.concrete.ripioWheelbarrows }} Carretillas</v-chip>
                </v-card>
              </v-col>
              ...
              <v-col cols="6" sm="3">
                <v-card class="pa-3 rounded-xl border-0 stat-card-gradient-success text-center">
                  ...
                  <v-chip size="x-small" color="info" variant="tonal" class="mt-1">~{{ Math.ceil(results.concrete.waterL / 20) }} Latas 20L</v-chip>
                </v-card>
              </v-col>
            </v-row>
          </div>
